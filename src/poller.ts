 ...
 */
const main = async () => {
	let height = await ArCache.getCurrentHeight() 
	...
	while(true){
		...
		console.log('DEBUG: blockDtos[0].height =', blockDtos[0].height)
		console.log('DEBUG: blockDtos[1].height =', blockDtos[1].height)
